...
const translations = {
  en: {
    ...
    fillRequiredFieldsProject: "Please fill in all fields (Title, End Date, Team Leader)",
    projectCreatedSuccess: "New project created and notification sent to Team Leader successfully!",
    ...
    firstTimeResetDesc: "Please change your password for safety before getting started",
    updatingPassword: "Updating...",
    saveNewPassword: "Save New Password",
    firstTimeResetSuccess: "Password updated successfully! Redirecting to dashboard...",
  ...
  th: {
    ...
    fillRequiredFieldsProject: "กรุณากรอกข้อมูลให้ครบถ้วนทุกช่อง (Title, End Date, Team Leader)",
    projectCreatedSuccess: "สร้างโปรเจกต์ใหม่และส่งการแจ้งเตือนไปยัง Team Leader สำเร็จ!",
    ...
    firstTimeResetDesc: "กรุณาเปลี่ยนรหัสผ่านเพื่อความปลอดภัยก่อนเริ่มต้นใช้งาน",
    updatingPassword: "กำลังเปลี่ยนรหัสผ่าน...",
    saveNewPassword: "บันทึกรหัสผ่านใหม่",
    firstTimeResetSuccess: "เปลี่ยนรหัสผ่านสำเร็จ! กำลังนำคุณเข้าสู่หน้าแดชบอร์ด...",
