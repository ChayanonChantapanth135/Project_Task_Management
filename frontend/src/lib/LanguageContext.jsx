...
const translations = {
  ...
  th: {
    ...
    taskTypeStoryboard: "สตอรี่บอร์ด/บท (Storyboard & Script)",
    taskTypeGraphicDesign: "ออกแบบกราฟิก/ภาพ (Graphic & Design)",
    taskTypeAnimation: "อนิเมชัน (Animation)",
    taskTypeVideoEdit: "ตัดต่อ (Video Edit)",
    taskTypeDevelopment: "พัฒนาโปรแกรม/ระบบ (Development)",
    ...
    statusUpdatedSuccess: "อัปเดตสถานะงานสำเร็จ",
    statusUpdateFailed: "ไม่สามารถอัปเดตสถานะงานได้",
  },
};
