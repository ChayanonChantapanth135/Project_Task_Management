...
const translations = {
  en: {
    ...
    teamStatusDistributionDesc: "Distribution of tasks by current status across the entire team",
    teamMemberWorkloadTitle: "Member Task Completion & Workload",
    teamMemberWorkloadDesc: "Comparison of assigned vs completed tasks per team member",
    projectHealthStatusTitle: "Project Status Breakdown",
    projectHealthStatusDesc: "Distribution of managed projects categorized by progress status",
    projectProgressOverviewTitle: "Project Progress & Delivery Rates",
    projectProgressOverviewDesc: "Completion percentage and delivery performance per managed project",
    taskNameLabel: "TASK NAME",
    taskProjectLabel: "PROJECT",
    taskTypeLabel: "TASK TYPE",
    taskStatusLabel: "STATUS",
  ...
  th: {
    ...
    projectDetailsLeader: "หัวหน้าทีมผู้รับผิดชอบ (Team Leader)",
    projectDetailsManager: "ผู้จัดการโปรเจกต์ (Project Manager)",
    ...
    teamStatusDistributionDesc: "ภาพรวมการกระจายสถานะของงานทั้งหมดที่สมาชิกในทีมรับผิดชอบ",
    teamMemberWorkloadTitle: "ภาระงานและความสำเร็จของสมาชิกในทีม",
    teamMemberWorkloadDesc: "เปรียบเทียบจำนวนงานที่ได้รับมอบหมายและงานที่ทำเสร็จของสมาชิกแต่ละคน",
    projectHealthStatusTitle: "สัดส่วนสถานะโครงการ",
    projectHealthStatusDesc: "ภาพรวมการกระจายตัวของโครงการที่ดูแลตามสถานะการดำเนินงาน",
    projectProgressOverviewTitle: "ความคืบหน้าและการส่งมอบโครงการ",
    projectProgressOverviewDesc: "เปอร์เซ็นต์ความสำเร็จของแต่ละโครงการที่อยู่ในความดูแล",
    taskNameLabel: "ชื่องาน",
