    ...
    <div ref={pageRef} className="min-h-screen flex flex-col bg-[#153648] text-slate-100 font-sans relative overflow-hidden">
      ...
      <main className="flex-1 p-6 max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <button 
            className="px-5 py-2.5 bg-slate-900/80 hover:bg-slate-800 text-slate-300 hover:text-white text-xs font-semibold flex items-center gap-2 rounded-full transition-all"
            onClick={loadData}
          >
            <span>⭮</span> {language === "th" ? "รีเฟรชข้อมูล" : "Refresh"}
          </button>
        </div>
