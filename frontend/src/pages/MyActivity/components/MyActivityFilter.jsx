      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="md:col-span-2 relative">
          ...
          <input
            ...
            placeholder={t("searchActivityPlaceholder") || "Search activities..."}
            value={searchQuery}
            onChange={(e) => {
        ...
        <div>
          ...
          >
            <option value="all" className="bg-slate-900">{t("allActivities") || "All Activities"}</option>
            <option value="project" className="bg-slate-900">{t("aboutProjects") || "Projects"}</option>
            <option value="user" className="bg-slate-900">{t("aboutUsers") || "Users"}</option>
            <option value="system" className="bg-slate-900">{t("aboutSystem") || "System"}</option>
          </select>
        </div>
      </div>
    </div>
